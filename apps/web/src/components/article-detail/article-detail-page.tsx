      ...
      <article className="detail-shell">
        ...
        <header className="article-hero">
          ...
          <div className="article-byline">
            <div className="publisher-mark" aria-hidden="true">
              {article.publisher.slice(0, 1)}
            </div>
            <div>
            ...
            <BookmarkButton
              active={bookmarks.includes(article.id)}
        ...
        <figure className="detail-image">
          ...
          <figcaption>{article.publisher}</figcaption>
        </figure>
        <div className="reading-toolbar">
          <span className="reading-label">Briefly audio edition</span>
